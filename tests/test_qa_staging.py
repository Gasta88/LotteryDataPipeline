...
class QaStagingTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.registration_content = [('2018-01-01 00:03:00.3136468','websiteF','riio@uqkry-.org','1988-12-13 16:57:40.7219400','Justin Dorsey','Rickey Villa','960 Nobel Boulevard','40 Fabien Boulevard','Michigan','Arkansas','63 Second St.','2018-01-01 00:03:00.3136468','477952'),
                                    ...
                                    ('2018-01-01 00:05:58.4257365','websiteE','snnd.kyjs@nzcly.lfebpe.net','Lesley Carroll','Heidi Bray','353 White Clarendon Road','323 North First Way','Missouri','76737','Tennessee','46 Old Blvd.','2018-01-01 00:05:58.4257365','97135'),
                                    ('2018-01-01 00:05:58.4257365','websiteE','snnd.kyjs@nzcly.lfebpe.net','Lesley Carroll','Heidi Bray','353 White Clarendon Road','323 North First Way','Missouri','76737','Tennessee','46 Old Blvd.','2018-01-01 00:05:58.4257365','97135')]
        self.games_content = [('2018-11-13 06:30:52.1998217','websiteH','667124','eur','0716','gslsngoldenesieben','2.0','0.4','GOV7'),	
                            ('2019-01-17 00:55:44.1996456','websiteZ','666294','eur','0148','Nikolos','3.0','0.8','HUC49302'),	
                            ('2019-01-17 00:55:44.1996456','websiteZ','','eur','','Nikolos','','0.8','HUC49302'),	
                            ('2019-01-17 00:55:44.1996456','websiteZ','666294','eur','0148','Nikolos','-3.0	-0.8','HUC49302')]
        self.lottery_content = [('1558931809','websiteA','132197','eur','600.0','60.0','LOTTO','ZAH1258','34771','12','{"discountInMinor":120,"type":"marketing"}'),
                                ('1544542681','websiteE','131323','eur','750.0','-75.0','CASH_4_LIFE','HAC4670','93454','3','{"discountInMinor":120,"type":"marketing"}'),
                                ('1544542681','websiteE','131323','eur','-750.0','75.0','CASH_4_LIFE','HAC4670','93454','3','{"discountInMinor":120,"type":"marketing"}'),
                                ('1544542681','websiteE','131323','eur','','75.0','CASH_4_LIFE','HAC4670','93454','3','{"discountInMinor":120,"type":"marketing"}')]
